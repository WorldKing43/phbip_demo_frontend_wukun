          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="网格办编号">
                <el-input v-model="houseInfoPreDTO.serialNo" placeholder="请输入" clearable  disabled></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="不动产权单元号">
                <el-input v-model="houseInfoPreDTO.immovablePropertyUnitNo" placeholder="请输入" clearable  disabled></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="24">
              <el-form-item label="小区名称">
                <el-input v-model="houseInfoPreDTO.districtName" readonly  disabled></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="栋号">
               <el-input v-model="houseInfoPreDTO.buildNo" readonly disabled></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="栋名称" required>
                <el-input v-model="houseInfoPreDTO.buildName" readonly disabled></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="房号" required>
                <el-input v-model="houseInfoPreDTO.houseNo" placeholder="请输入" clearable disabled></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="不动产权证书号">
                <el-input v-model="houseInfoPreDTO.rightOverImmovablesId" placeholder="请输入" clearable disabled></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="初始产权归属" required >
                <el-select v-model="houseInfoPreDTO.propertypBelong" filterable clearable placeholder="点击输入进行相关搜索" disabled>
            ...
            <el-col :span="12">
              <el-form-item label="初始房源性质" required >
                <el-select v-model="houseInfoPreDTO.startNature" clearable disabled>
            ...
            <el-col :span="12">
              <el-form-item label="房屋来源" required >
                <el-select v-model="houseInfoPreDTO.source" clearable disabled>
            ...
            <el-col :span="12">
              <el-form-item label="房屋用途" required >
                <el-select v-model="houseInfoPreDTO.function" clearable disabled>
            ...
            <el-col :span="12">
              <el-form-item label="所在单元" >
                <el-input v-model="houseInfoPreDTO.unit" placeholder="请输入" clearable disabled></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="所在楼层">
                <el-input v-model="houseInfoPreDTO.floorNo" placeholder="请输入" clearable disabled></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="户型" required>
                <el-select v-model="houseInfoPreDTO.houseLayout" clearable disabled>
            ...
            <el-col :span="12">
              <el-form-item label="朝向" required>
                <el-select v-model="houseInfoPreDTO.orientation" clearable disabled>
            ...
            <el-col :span="12">
              <el-form-item label="是否有架空层" required>
                <el-select v-model="houseInfoPreDTO.innerFloor" clearable disabled>
            ...
            <el-col :span="12">
              <el-form-item label="平台" required> 
                <el-select v-model="houseInfoPreDTO.terrace" clearable disabled>
            ...
            <el-col :span="12">
              <el-form-item label="预测绘建筑面积">
                <DistInputNumber v-model="houseInfoPreDTO.coveredArea" placeholder="请输入" unit="平方米" size="mini"
                  :min="0" disabled></DistInputNumber>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="预测绘套内面积">
                <DistInputNumber v-model="houseInfoPreDTO.indoorArea" placeholder="请输入" unit="平方米" size="mini" :min="0" disabled>
                </DistInputNumber>
              </el-form-item>
            </el-col>
            <el-col :span="12">
            ...
            <el-col :span="12">
              <el-form-item label="分摊面积说明">
                <el-input v-model="houseInfoPreDTO.residentialAreaContent" placeholder="请输入" clearable disabled></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="竣工建筑面积">
                <DistInputNumber v-model="houseInfoPreDTO.completionArea" placeholder="请输入" unit="平方米" size="mini" disabled 
                  :min="0"></DistInputNumber>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="竣工分摊面积">
                <DistInputNumber v-model="houseInfoPreDTO.completionShareArea" placeholder="请输入" unit="平方米" size="mini" disabled
                  :min="0"></DistInputNumber>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="竣工套内面积">
                <DistInputNumber v-model="houseInfoPreDTO.completionIndoorArea" placeholder="请输入" unit="平方米" size="mini" disabled
                  :min="0"></DistInputNumber>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="是否样板房">
                <el-select v-model="houseInfoPreDTO.modelHouses" clearable disabled>
                  <el-option v-for="(item,index) in twoChooseList" :key="index" :label="item.name" :value="item.value" >
                  </el-option>
                </el-select>
              </el-form-item>
            ...
            <el-col :span="12">
              <el-form-item label="是否代售">
                <el-select v-model="houseInfoPreDTO.helpSell" clearable disabled>
                  <el-option v-for="(item,index) in twoChooseList" :key="index" :label="item.name" :value="item.value">
                  </el-option>
                </el-select>
              </el-form-item>
            ...
            <el-col :span="12">
              <el-form-item label="装修标准">
                <!-- required -->
                <el-select v-model="houseInfoPreDTO.decorationType"  clearable disabled>
            ...
            <el-col :span="12">
              <el-form-item label="竣工时间">
                <el-date-picker type="date" placeholder="选择日期" v-model="houseInfoPreDTO.finishConstructionTime" disabled
                  style="width: 100%;"></el-date-picker>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="交付使用时间">
                <el-date-picker type="date" placeholder="选择日期" v-model="houseInfoPreDTO.deliveryTime" disabled
                  style="width: 100%;">
                </el-date-picker>
              </el-form-item>
            </el-col>
            <el-col :span="24">
              <el-form-item label="备注">
                <el-input type="textarea" v-model="houseInfoPreDTO.specification" autosize disabled></el-input>
              </el-form-item>
            </el-col>
          </el-row>
        </div>
  ...
  methods: {
    ...
    getHouseInfo() {
      let params = {
          ...
          reportGuid:  this.$parent.meta.reportGuid,
          configName: this.$parent.meta.itemName
        };
      http
        .getHouseInfo(params)
        .then(res => {
