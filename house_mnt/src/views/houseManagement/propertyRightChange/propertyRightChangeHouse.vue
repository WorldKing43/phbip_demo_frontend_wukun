      ...
      <div class="margin30">
        ...
        >
          <el-row :gutter="10">
            ...
            <el-col :span="6">
              <el-form-item label="产权单位" label-width="4.5rem">
                <el-select
                  v-model="waitSelectedForm.propertyRight"
                  placeholder
                  style="width: 100%"
                  clearable
                  filterable
            ...
            <el-col :span="24">
              <el-form-item style="float:right">
                <el-button
                  ...
                  v-if="hasPerm('fygl_fycqbg_fyxx_cx')"
                  :disabled="edit"
                >查询</el-button>
                <el-button type="primary" size="mini" @click="WaitSelectedAll" :disabled="edit">全选</el-button>
              </el-form-item>
            </el-col>
          </el-row>
        </el-form>
        ...
        <div class="table-list">
          ...
          >
            ...
            <el-table-column prop="propertyRightUnit" label="产权归属单位"></el-table-column>
          </el-table>
          <div class="table-foot">
            <div>
              <el-button
                ...
                :disabled="edit"
                v-if="hasPerm('fygl_fycqbg_fyxx_qr')"
              >确认</el-button>
            </div>
            <!-- 分页功能 -->
            ...
            <el-col :span="24">
              <el-form-item style="float:right">
                <el-button
                  ...
                  v-if="hasPerm('fygl_fycqbg_fyxx_cx')"
                >查询</el-button>
                <el-button type="primary" size="mini" @click="selectHouseAll" :disabled="edit">全选</el-button>
              </el-form-item>
            </el-col>
          </el-row>
        </el-form>
          ...
          <div class="table-foot">
            <div>
              <el-button
                ...
                :disabled="edit"
                v-if="hasPerm('fygl_fycqbg_fyxx_yc')"
              >移除</el-button>
            </div>
            <!-- 分页功能 -->
            <div class="block" align="center">
      ...
      <div>
        ...
        <div class="housing">
          ...
          <div class="area end-area">
            ...
            >
              <el-table-column prop="name" label="产权归属单位" align="center"></el-table-column>
              <el-table-column prop="value" label="数量" align="center"></el-table-column>
            </el-table>
          </div>
        </div>
...
export default {
  data() {
    return {
      ...
      edit: true, //判断按钮是否被禁用
      propertyRightUnitOptions: [], //产权单位下拉
  ...
  methods: {
    ...
    queryWaitSelectedList(index) {
      ...
      let data = {
        ...
        propertyRight: this.waitSelectedForm.propertyRight,
    ...
    addHouseToSelectHouse() {
      ...
      api
        ...
        .then(res => {
          ...
          this.Event.$emit("propertyRightChangeApplyInfo", "getChangeInfo");
          if (this.waitSelectAllFlag) {
  ...
  mounted() {
    ...
    this.getPropertyRightUnit(); //获取产权单位
