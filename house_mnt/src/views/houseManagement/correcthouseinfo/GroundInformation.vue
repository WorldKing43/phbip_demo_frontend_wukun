    ...
    <div>
              ...
              <el-form-item>
                <div>
                  <el-button
                    ...
                    v-if="hasPerm('fygl_fyxxkw_zdxx_cx')"
                  ...
                  <el-button
                    ...
                    size="mini"
                    @click="reset"
                    v-if="hasPerm('fygl_fyxxkw_zdxx_cz')"
                  >重置</el-button>
                </div>
              </el-form-item>
            </el-col>
      ...
      <div class="table-list" style="margin-top: 10px;margin-bottom:10px;">
        ...
        >
          ...
          >
            <template slot-scope="scope">
              <el-button type="primary" size="mini" @click="editGroundInfo(scope.row)">查看</el-button>
              <el-button
                type="primary"
                size="mini"
                @click="deleteLandNo(scope.row)"
                :disabled="!(scope.row.dataGuid == 99)"
              >删除</el-button>
            </template>
          </el-table-column>
          <el-table-column
      ...
      api
        ...
        .then(res => {
          if (res) {
            ...
            this.Event.$emit("NeighbourhoodDetail", "getNeighbourhoodDetail");
          }
        })
        .catch(err => {
          console.log(err);
