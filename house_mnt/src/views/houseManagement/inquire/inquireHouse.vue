 ...
 * @LastEditTime: 2020-08-31 11:29:58
 -->
<!--房屋综合查询-->
<template>
...
export default {
  ...
  methods: {
    ...
    exportProposedDistributionHouse() {
      let url = "";
      url = process.env.API + inquery.exportProposedDistributionHouse+
        "?districtNo=" +
        this.form.districtNo +
        "&districtName=" +
        this.form.districtName +
    ...
    exportHouseBatchInfo() {
      let url = "";
      url = process.env.API + inquery.exportHouseBatchInfo;
      //window.location.href = url;
      var elemIF = document.createElement("iframe");
      elemIF.src = url;
      elemIF.style.display = "none";
