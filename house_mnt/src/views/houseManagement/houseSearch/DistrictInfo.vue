  ...
  <div class="neighbourhoodInfo tableStyle">
    <table>
      ...
      <tr>
        <td>所在区</td>
        <td>
          <el-select style="width: 100%;" v-model="form.area" placeholder disabled>
            <el-option
      ...
      <tr>
        ...
        <td>是否自建</td>
        <td>
          <el-select style="width: 100%;" v-model="form.selfBuilt" placeholder disabled>
            <el-option
              v-for="item in options"
              :key="item.value"
              :label="item.label"
      ...
      <tr>
        <td>是否代售</td>
        <td>
          <el-select style="width: 100%;" v-model="form.helpSale" placeholder disabled>
            <el-option
              v-for="item in options"
              :key="item.value"
              :label="item.label"
         ...
         <td>装修标准</td>
        <td>
          <el-select style="width: 100%;" v-model="form.decorationStandard" placeholder disabled>
            <el-option
...
export default {
  ...
  data() {
    return {
      form: {},
      options: [{ value: true, label: "是" }, { value: false, label: "否" }], //是否自管，是否自建下拉菜单
      guid: "",
      areaDataType: [], //所在区
