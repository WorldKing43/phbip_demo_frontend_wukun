<!--房详情-->
<template>
	<div class="vacuumRoomDetail">
		<div class="house-details">
			<div class="buttonGroup">
				<el-button type="primary" size="mini" @click="goback">返回</el-button>
				<el-button type="primary" size="mini" @click="openLogDialog">查看日志</el-button>
				<el-button type="primary" size="mini" @click="location">地图定位</el-button>
			</div>
			<div class="tableStyle">
				<el-collapse v-model="openCollapse">
						...
						<div>
							<table class="detail">
								...
								<tr>
									...
									<td>
										<el-select style="width: 100%" v-model="form.source" disabled>
											<el-option v-for="(item, index) in sourceData" :key="index" :label="item.name" :value="item.value"></el-option>
										</el-select>
									</td>
								</tr>
								<tr>
									...
									<td>
										<el-select style="width: 100%" v-model="form.function" disabled>
											<el-option v-for="(item, index) in functionData" :key="index" :label="item.name" :value="item.value"></el-option>
										</el-select>
									</td>
									<td>户型</td>
									<td>
										<el-select v-model="form.houseLayout" placeholder="请选择" style="width: 100%" disabled>
								...
								<tr>
									<td>朝向</td>
									<td>
										<el-select style="width: 100%" v-model="form.orientation" placeholder="请选择" disabled>
											<el-option v-for="(item, index) in orientationData" :key="index" :label="item.name" :value="item.value"></el-option>
										</el-select>
									</td>
									<td>平台</td>
									<td>
										<el-select v-model="form.terrace" placeholder="请选择" style="width: 100%" disabled>
											<el-option v-for="(item, index) in terraceData" :key="index" :label="item.name" :value="item.value"></el-option>
										</el-select>
									</td>
								</tr>
								<tr>
									<td>是否有架空层</td>
									<td>
										<el-select style="width: 100%" v-model="form.innerFloor" placeholder="请选择" disabled>
								...
								<tr>
									...
									<td>
										<el-select style="width: 100%" v-model="form.startNature" disabled>
											<el-option v-for="(item, index) in houseType" :label="item.name" :value="item.value" :key="index"></el-option>
										</el-select>
									</td>
									<td>当前房源性质</td>
									<td style="position: relative">
										...
										<el-button type="primary" size="mini" style="position: absolute; top: 6px; right: 2px" @click="OpenNatureRecordsDialog">查看历史</el-button>
									</td>
								</tr>
								<tr>
									<td>初始属性</td>
									<td>
										<el-select style="width: 100%" v-model="form.originalProperty" disabled>
											<el-option v-for="(item, index) in currentPropertyData" :label="item.name" :value="item.value" :key="index"></el-option>
										</el-select>
									</td>
									<td>当前属性</td>
									<td>
										<el-select style="width: 100%" v-model="form.currentProperty" disabled>
											<el-option v-for="(item, index) in originalPropertyData" :label="item.name" :value="item.value" :key="index"></el-option>
										</el-select>
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td colspan="3">
										<el-tooltip class="item" effect="dark" content="此处利用鼠标可拖动" placement="right-end">
											<el-input type="textarea" :autosize="{ minRows: 2, maxRows: 4 }" placeholder="请输入内容" v-model="form.decorationTypeDescription"
											 disabled></el-input>
										</el-tooltip>
									</td>
								</tr>
								<tr>
									<td>是否样板房</td>
									<td>
										<el-select style="width: 100%" v-model="form.modelHouses" placeholder="请选择" disabled>
											<el-option v-for="item in options" :key="item.value" :label="item.label" :value="item.value"></el-option>
										</el-select>
									</td>
									<td>是否代售</td>
									<td>
										<el-select style="width: 100%" v-model="form.helpSell" placeholder="请选择" disabled>
											<el-option v-for="item in options" :key="item.value" :label="item.label" :value="item.value"></el-option>
										</el-select>
									</td>
								</tr>
								...
								<tr>
									...
									<td>是否被二次分配</td>
									<td>
										<el-select style="width: 100%" v-model="form.secondDistribution" placeholder="请选择" disabled>
											<el-option v-for="item in options" :key="item.value" :label="item.label" :value="item.value"></el-option>
										</el-select>
									</td>
								</tr>
								<tr>
									...
									<td colspan="3" style="position: relative">
										<el-select style="width: 100%" v-model="form.maintainType" placeholder="请选择" disabled>
											<el-option v-for="(item, index) in stateList" :key="index" :label="item.name" :value="item.value"></el-option>
										</el-select>
										<el-button type="primary" size="mini" @click="checkHistory" style="position: absolute; top: 6px; right: 2px">查看历史</el-button>
									</td>
								</tr>
								<tr>
									<td>备注</td>
								...
								<tr>
									...
									<td>
										<el-select v-model="form.initialAllocationRight" style="width: 100%" disabled>
											<el-option v-for="(item, index) in divisionUnit" :label="item.name" :value="item.value" :key="index"></el-option>
										</el-select>
									</td>
									<td>当前分配权归属</td>
									<td style="position: relative">
										...
										<el-button type="primary" size="mini" style="position: absolute; top: 6px; right: 2px" @click="OpenAllocationRecordsDialog">查看历史</el-button>
									</td>
								</tr>
								<tr>
									<td>初始签约权归属</td>
									<td>
										<el-select v-model="form.initialSignatoryRight" style="width: 100%" disabled>
											<el-option v-for="(item, index) in signingUnit" :label="item.name" :value="item.value" :key="index"></el-option>
										</el-select>
									</td>
									<td>当前签约权归属</td>
									<td style="position: relative">
										...
										<el-button type="primary" size="mini" style="position: absolute; top: 6px; right: 2px" @click="OpenSignatoryRightRecordsDialog">查看历史</el-button>
									</td>
								</tr>
								<tr>
									<td>初始数据维护权归属</td>
									<td>
										<el-select v-model="form.initialMaintainRight" style="width: 100%" disabled>
											<el-option v-for="(item, index) in maintenanceUnit" :label="item.name" :value="item.value" :key="index"></el-option>
										</el-select>
									</td>
									<td>当前数据维护权归属</td>
									<td style="position: relative">
										...
										<el-button type="primary" size="mini" style="position: absolute; top: 6px; right: 2px" @click="OpenInitialMaintainRightRecordsDialog">查看历史</el-button>
									</td>
								</tr>
								<tr>
									<td>初始运维权归属</td>
									<td>
										<el-select v-model="form.initialOperationalRight" style="width: 100%" disabled>
											<el-option v-for="(item, index) in operations" :label="item.name" :value="item.value" :key="index"></el-option>
										</el-select>
									</td>
									<td>当前运维权归属</td>
									<td style="position: relative">
										...
										<el-button type="primary" size="mini" style="position: absolute; top: 6px; right: 2px" @click="OpenOperationalRightRecordsDialog">查看历史</el-button>
									</td>
								</tr>
					...
					<el-collapse-item name="3">
						<template slot="title">
							<TitleStylex title="房源产权信息">
								<el-button slot="publicTitleRight" type="primary" size="mini" @click="OpenPropertyRightRecordsDialog">查看历史产权变更记录</el-button>
							</TitleStylex>
						</template>
						<div>
							<table class="detail">
					...
					<el-collapse-item name="4">
						...
						<div>
							<el-table :data="incomingAndOutgoingStatusList" border size="mini" :header-cell-style="globalHeaderStyle"
							 :cell-style="globalCellStyle">
								<el-table-column label="正式入库时间">
									<template slot-scope="scope">{{
                  scope.row.storageTime | dateFormat
                }}</template>
								</el-table-column>
								...
								<el-table-column label="出库时间">
									<template slot-scope="scope">{{
                  scope.row.outboundTime | dateFormat
                }}</template>
								</el-table-column>
					...
					<el-collapse-item name="5">
						...
						<div>
							<el-table :data="situationalList" border size="mini" :header-cell-style="globalHeaderStyle" :cell-style="globalCellStyle">
                  ...
                  scope.row.removeDate | dateFormat
					...
					<el-collapse-item name="6">
						...
						<div>
							<el-table :data="relieveList" border size="mini" :header-cell-style="globalHeaderStyle" :cell-style="globalCellStyle">
								<el-table-column type="index" label="序号" width="50"></el-table-column>
					...
					<el-collapse-item name="7">
						...
						<div>
							<el-table :data="rentSituationList" border size="mini" :header-cell-style="globalHeaderStyle" :cell-style="globalCellStyle">
                  ...
                  scope.row.pczssj | dateFormat
								...
								<el-table-column label="首次合同开始时间">
									<template slot-scope="scope">{{
                  scope.row.schtkssj | dateFormat
                }}</template>
								</el-table-column>
								<el-table-column label="合同开始时间">
									<template slot-scope="scope">{{
                  scope.row.htkssj | dateFormat
                }}</template>
								</el-table-column>
								<el-table-column label="合同结束时间">
									<template slot-scope="scope">{{
                  scope.row.htjssj | dateFormat
                }}</template>
								</el-table-column>
								<el-table-column prop="lsxyqk" label="临时协议情况"></el-table-column>
								<el-table-column label="详情">
									<template slot-scope="scope">
										<el-button type="primary" size="mini" @click="openRentSituationDetailDialog(scope.row)">查看</el-button>
									</template>
								</el-table-column>
							</el-table>
						</div>
					...
					<el-collapse-item name="8">
						...
						<div>
							<el-table :data="erratList" border size="mini" :header-cell-style="globalHeaderStyle" :cell-style="globalCellStyle">
								<el-table-column type="index" label="序号" width="50"></el-table-column>
                  ...
                  scope.row.kwsj | dateFormat
								...
								<el-table-column label="操作">
									<template slot-scope="scope">
										<el-button type="primary" size="mini" @click="openHouseErrataDetailDialog(scope.row)">查看详情</el-button>
									</template>
								</el-table-column>
							</el-table>
							<div class="page_box">
								<el-pagination @size-change="handleHouseSizeChange" @current-change="handleHouseCurrentChange" :current-page="errataDetailPage.currentPage"
								 :page-sizes="errataDetailPage.pageSizesList" :page-size="errataDetailPage.pageSize" layout="total, sizes, prev, pager, next, jumper"
								 :total="errataDetailPage.totalNumber" background></el-pagination>
							</div>
						</div>
					</el-collapse-item>
				</el-collapse>
				<!-- 核销模块 -->
				<!-- <publicTitle title="核销情况"></publicTitle>
      <table class="detail" :model="outstock">
        <tr>
          <td>核销原因</td>
          <td>{{ outstock.reason }}</td>
          <td>核销依据</td>
          <td>{{ outstock.basis }}</td>
        </tr>
        <tr>
          <td>核销人</td>
          <td>{{ outstock.handlerName }}</td>
          <td>核销时间</td>
          <td>
            <el-date-picker
              v-model="outstock.time"
              type="date"
              style="width:100%"
              disabled
              placeholder="选择日期"
			...
			<!-- 查看详情 -->
			<el-dialog :visible.sync="checkAttachmentDialog" width="60%" title="查看附件" style="margin-top: 10px" class="dialog"
			...
			<!-- 查看历史产权变更记录 -->
			<el-dialog :visible.sync="propertyRightRecordsDialog" width="80%" title="查看历史" class="dialog" :close-on-click-modal="false">
				<publicTitle title="变更情况"></publicTitle>
				<div class="table">
					<el-table :data="propertyRightRecordsList" border size="mini" :header-cell-style="globalHeaderStyle" :cell-style="globalCellStyle">
              ...
              scope.row.changTime | dateFormat
						...
						<el-table-column label="查看变更详情">
							<template slot-scope="scope">
								<el-button type="primary" size="mini" @click="OpenPropertyRightRecordsDetailDialog(scope.row)">查看</el-button>
							</template>
						</el-table-column>
					</el-table>
				</div>
			...
			<!-- 查看房源性质变更情况 -->
			<el-dialog :visible.sync="natureRecordsDialog" width="80%" title="查看历史" class="dialog" :close-on-click-modal="false">
				<publicTitle title="查看房源性质变更情况"></publicTitle>
				<div class="table">
					<el-table :data="natureChangeRecordsList" border size="mini" :header-cell-style="globalHeaderStyle" :cell-style="globalCellStyle">
						<el-table-column label="序号" type="index"></el-table-column>
						<el-table-column label="变更时间">
							<template slot-scope="scope">{{
              scope.row.changTime | dateFormat
						...
						<el-table-column label="查看变更详情">
							<template slot-scope="scope">
								<el-button type="primary" size="mini" @click="OpenNatureRecordsDetailDialog(scope.row)">查看</el-button>
							</template>
						</el-table-column>
					</el-table>
				</div>
			...
			<el-dialog :visible.sync="historyRecordsDialog" width="80%" :title="title" class="dialog" :close-on-click-modal="false">
				<publicTitle title="变更情况"></publicTitle>
				<div class="table" v-if="this.title == '查看分配权变更情况'">
					<el-table :data="allocationRecordsList" border size="mini" :header-cell-style="globalHeaderStyle" :cell-style="globalCellStyle">
						<el-table-column label="序号" type="index"></el-table-column>
						<el-table-column label="变更时间">
							<template slot-scope="scope">{{
              scope.row.time | dateFormat
				...
				<div class="table" v-if="this.title == '查看签约权变更情况'">
					<el-table :data="signatoryRightRecordsList" border size="mini" :header-cell-style="globalHeaderStyle" :cell-style="globalCellStyle">
						<el-table-column label="序号" type="index"></el-table-column>
						<el-table-column label="变更时间">
							<template slot-scope="scope">{{
              scope.row.time | dateFormat
				...
				<div class="table" v-if="this.title == '查看数据维护权变更情况'">
					<el-table :data="InitialMaintainRightRecordsList" border size="mini" :header-cell-style="globalHeaderStyle"
					 :cell-style="globalCellStyle">
						<el-table-column label="序号" type="index"></el-table-column>
						<el-table-column label="变更时间">
							<template slot-scope="scope">{{
              scope.row.time | dateFormat
				...
				<div class="table" v-if="this.title == '查看运维权变更情况'">
					<el-table :data="perationalRightRecordsList" border size="mini" :header-cell-style="globalHeaderStyle" :cell-style="globalCellStyle">
						<el-table-column label="序号" type="index"></el-table-column>
						<el-table-column label="变更时间">
							<template slot-scope="scope">{{
              scope.row.time | dateFormat
			...
			<!-- 查看勘误详情弹框 -->
			<el-dialog :visible.sync="houseErrataDetailDialog" width="80%" title="查看历史" class="dialog" :close-on-click-modal="false">
				<publicTitle title="查看勘误详情"></publicTitle>
				<div class="table">
					<el-table :data="erratDetailList" border size="mini" :header-cell-style="globalHeaderStyle" :cell-style="globalCellStyle">
						<el-table-column label="序号" type="index"></el-table-column>
              ...
              scope.row.changeTime | dateFormat
					...
					<div class="page_box">
						<el-pagination @size-change="houseSizeCurrentChange" @current-change="houseIndexCurrentChange" :current-page="errataInfoPage.currentPage"
						 :page-sizes="errataInfoPage.pageSizesList" :page-size="errataInfoPage.pageSize" layout="total, sizes, prev, pager, next, jumper"
						 :total="errataInfoPage.totalNumber" background></el-pagination>
					</div>
				</div>
			</el-dialog>

			<!-- 查看勘误面积详情弹框 -->
			<el-dialog :visible.sync="houseErrataImportDetailDialog" width="80%" title="查看勘误详情" class="dialog"
			 :close-on-click-modal="false">
				<div class="table">
					<el-table :data="erratImportList" border size="mini" :header-cell-style="globalHeaderStyle" :cell-style="globalCellStyle">
						<el-table-column label="序号" type="index"></el-table-column>
			...
			<!-- 查看勘误面积详情弹框 -->
			<el-dialog :visible.sync="houseErrataAreaDetailDialog" width="80%" title="查看勘误详情" class="dialog"
			 :close-on-click-modal="false">
				<div class="table">
					<el-table :data="erratAreaList" border size="mini" :header-cell-style="globalHeaderStyle" :cell-style="globalCellStyle">
						<el-table-column label="序号" type="index"></el-table-column>
						<el-table-column prop="DONGH" label="栋号"></el-table-column>
						<el-table-column prop="DONGMC" label="栋名称"></el-table-column>
			...
			<!-- 查看房源产权变更详情 -->
			<el-dialog :visible.sync="propertyRightRecordsDetailDialog" width="80%" title="查看产权详细情况" class="dialog"
			 :close-on-click-modal="false">
				...
				<div class="table">
					<el-table :data="propertyRightDetailTable" border size="mini" :header-cell-style="globalHeaderStyle" :cell-style="globalCellStyle">
					...
					<div class="page_box">
						<el-pagination @size-change="propertyRightDetailSizeChange" @current-change="propertyRightDetailCurrentChange"
						 :current-page="propertyRightDetailPage.currentPage" :page-sizes="propertyRightDetailPage.pageSizesList"
						 :page-size="propertyRightDetailPage.pageSize" layout="total, sizes, prev, pager, next, jumper" :total="propertyRightDetailPage.totalNumber"
						 background></el-pagination>
					</div>
				</div>
				<div>
					<publicTitle title="审核意见"></publicTitle>
					<el-table :data="detailOpinion" border size="mini" :header-cell-style="globalHeaderStyle" :cell-style="globalCellStyle">
			...
			<!-- 查看房源性质变更详情 -->
			<el-dialog :visible.sync="natureRecordsDetailDialog" width="80%" title="查看性质变更详细情况" class="dialog"
			 :close-on-click-modal="false">
				...
				<div class="tableStyle">
					<table :model="natureDetailform" class="detail">
						...
						<tr>
							...
							<td colspan="3">
								<el-select style="width: 100%" placeholder="请选择" v-model="natureDetailform.nature" disabled>
									<el-option v-for="(item, index) in houseType" :key="index" :label="item.name" :value="item.value"></el-option>
								</el-select>
							</td>
						</tr>
						<tr>
				...
				<publicTitle title="选中房列表"></publicTitle>
				<div class="table">
					<el-table :data="natureDetailTable" border size="mini" :header-cell-style="globalHeaderStyle" :cell-style="globalCellStyle">
					...
					<div class="page_box">
						<el-pagination @size-change="natureDetailSizeChange" @current-change="natureDetailCurrentChange" :current-page="natureDetailPage.currentPage"
						 :page-sizes="natureDetailPage.pageSizesList" :page-size="natureDetailPage.pageSize" layout="total, sizes, prev, pager, next, jumper"
						 :total="natureDetailPage.totalNumber" background></el-pagination>
					</div>
				</div>
				<div>
					<publicTitle title="审核意见"></publicTitle>
			...
			<!--查看出租详情弹框 -->
			<el-dialog :visible.sync="rentSituationDetailDialog" width="80%" title="查看" class="dialog" :close-on-click-modal="false">
				<div>
				...
				<div class="tableStyle">
					<div v-if="this.housePlanInfoShow">
							...
							<tr>
								...
								<td>
									<el-radio-group disabled v-model="housePlanFrom.function" style="margin-left: 6px">
										<el-radio v-for="(item, index) in planUseData" :key="index" :label="item.value" :value="index">{{ item.name }}</el-radio>
									</el-radio-group>
								</td>
								<td class="must">计划属性</td>
								<td>
									<el-select v-model="housePlanFrom.property" placeholder="请先选择计划用途" style="width: 100%" disabled>
										<el-option v-for="(item, index) in planPropertyData" :key="index" :label="item.name" :value="item.value"></el-option>
									</el-select>
								</td>
							</tr>
							<tr>
								<td>供应计划</td>
								<td>
									<el-select disabled v-model="housePlanFrom.supplyCode" placeholder="请选择" style="width: 100%">
										<el-option v-for="(item, index) in supplyCodeOptions" :key="index" :label="item.name" :value="item.value"></el-option>
									</el-select>
								</td>
								<td>分配批次</td>
								<td>
						...
						<div>
							<!--表单-->
							<el-form :model="housePlanListForm" label-position="left" size="mini" label-width="3rem">
								<el-row :gutter="10">
									<el-col :span="6">
										<el-form-item label="小区">
											<el-input v-model="housePlanListForm.districtName" clearable @change="getHousePlanList(1)"></el-input>
										</el-form-item>
									</el-col>
									<el-col :span="6">
										<el-form-item label="栋号">
											<el-input v-model="housePlanListForm.buildName" clearable @change="getHousePlanList(1)"></el-input>
										</el-form-item>
									</el-col>
									<el-col :span="6">
										<el-form-item label="房号">
											<el-input v-model="housePlanListForm.houseNo" clearable @change="getHousePlanList(1)"></el-input>
										</el-form-item>
									</el-col>
									<el-col :span="6">
										<el-form-item label="户型">
											<el-select v-model="housePlanListForm.type" placeholder="请选择" style="width: 100%" clearable @change="getHousePlanList(1)">
								...
								<el-row :gutter="10">
									<el-col :span="6">
										<el-form-item label="状态">
											<el-select v-model="housePlanListForm.state" placeholder="请选择" style="width: 100%" clearable @change="getHousePlanList(1)">
												<el-option :label="item.name" :value="item.value" v-for="(item, index) in stateData" :key="index"></el-option>
											</el-select>
										</el-form-item>
									</el-col>
									<el-col :span="6">
										<el-form-item label="预测绘建筑面积" label-width="7.5rem">
											<el-row :gutter="0">
												<el-col :span="10">
													<el-input v-model="housePlanListForm.areaMin" clearable @change="getHousePlanList(1)"></el-input>
												</el-col>
												<el-col class="line" :span="4" style="text-align: center">至</el-col>
												<el-col :span="10">
													<el-input v-model="housePlanListForm.areaMax" clearable @change="getHousePlanList(1)"></el-input>
												</el-col>
											</el-row>
										</el-form-item>
									</el-col>
									<el-col :span="6">
										<el-form-item label="竣工建筑面积" label-width="6.5rem">
											<el-row :gutter="0">
												<el-col :span="11">
													<el-input v-model="housePlanListForm.completionAreabegain" clearable @change="getHousePlanList(1)"></el-input>
												</el-col>
												<el-col class="line" :span="2" style="text-align: center">-</el-col>
												<el-col :span="11">
													<el-input v-model="housePlanListForm.completionAreaEnd" clearable @change="getHousePlanList(1)"></el-input>
												</el-col>
											</el-row>
										</el-form-item>
									</el-col>
							...
							<!--表格-->
							<div>
								<el-table :data="housePlanList" border :header-cell-style="globalHeaderStyle" :cell-style="globalCellStyle">
							...
							<div class="page_box">
								<el-pagination @size-change="housePlanListSizeChange" @current-change="housePlanListCurrentChange"
								 :current-page="housePlanListPage.currentPage" :page-sizes="housePlanListPage.pageSizesList" :page-size="housePlanListPage.pageSize"
								 layout="total, sizes, prev, pager, next, jumper" :total="housePlanListPage.totalNumber" background></el-pagination>
							</div>
						</div>
						<div>
							<publicTitle title="审核意见"></publicTitle>
							<el-table :data="housePlanOpinion" border size="mini" :header-cell-style="globalHeaderStyle" :cell-style="globalCellStyle">
								<el-table-column prop="activitySource" label="环节"></el-table-column>
								<el-table-column prop="dealer" label="办理人"></el-table-column>
								<el-table-column prop="dealTime" label="办理时间"></el-table-column>
								<el-table-column prop="remark" label="办理意见"></el-table-column>
					...
					<div v-if="this.allocationBatchInfoShow">
						...
						<div v-if="this.distributionType == 11">
							...
							<table :model="batchInfo" class="detail">
								<tr>
									...
									<td>
										<el-select disabled v-model="batchInfo.supplyCode" placeholder="请选择" style="width: 100%">
											<el-option v-for="(item, index) in supplyCodeOptions" :key="index" :label="item.name" :value="item.value"></el-option>
										</el-select>
									</td>
									<td>批次代码</td>
								...
								<tr>
									...
									<td>
										<el-select v-model="batchInfo.distributeType" class="w100" clearable disabled>
											<el-option v-for="(item, index) in distributeTypeData" :key="index" :label="item.name" :value="item.value"></el-option>
										</el-select>
									</td>
								</tr>
								<tr>
									...
									<td>
										<el-cascader v-model="batchInfo.signTypeCascade" :options="signType" style="width: 100%" separator="=>"></el-cascader>
									</td>
								</tr>
								<tr>
									<td>合同类型</td>
									<td>
										<el-select v-model="batchInfo.contractType" placeholder="请选择" clearable style="width: 100%">
											<el-option v-for="(item, index) in contractType" :key="index" :label="item.name" :value="item.value"></el-option>
										</el-select>
									</td>
									<td>租金标准</td>
									<td>
										<el-select v-model="batchInfo.rentStandard" placeholder="请选择" clearable style="width: 100%" disabled>
											<el-option v-for="(item, index) in rentStandard" :key="index" :label="item.name" :value="item.value"></el-option>
										</el-select>
									</td>
								</tr>
								<tr>
									<td>租赁起始日期</td>
									<td>
										<el-date-picker style="width: 100%" v-model="batchInfo.rentalStartTime" disabled placeholder="点击请选择年月日"
										 label-width="7rem"></el-date-picker>
									</td>
									<td>租赁结束日期</td>
									<td>
										<el-date-picker style="width: 100%" v-model="batchInfo.rentalEndTime" disabled placeholder="点击请选择年月日"
										 label-width="7rem"></el-date-picker>
									</td>
								</tr>
								<tr>
									...
									<td>交租起始年月</td>
									<td>
										<el-date-picker style="width: 100%" v-model="batchInfo.rentStartTime" disabled placeholder="点击请选择年月日"
										 label-width="7rem"></el-date-picker>
									</td>
								</tr>
								<tr>
									...
									<td>
										<el-row :gutter="0">
											<el-col :span="11">
												<el-date-picker style="width: 100%" v-model="batchInfo.publicBeginDate" disabled placeholder="点击请选择年月日"
												 label-width="7rem"></el-date-picker>
											</el-col>
											<el-col :span="2">-</el-col>
											<el-col :span="11">
												<el-date-picker style="width: 100%" v-model="batchInfo.publicBeginEnd" disabled placeholder="点击请选择年月日"
												 label-width="7rem"></el-date-picker>
											</el-col>
										</el-row>
									</td>
									<td>批次结束时间</td>
									<td>
										<el-date-picker style="width: 100%" v-model="batchInfo.endDate" disabled placeholder="点击请选择年月日" label-width="7rem"></el-date-picker>
									</td>
								</tr>
								<tr>
						...
						<!-- 配租周转房页面、定向个人、定向单位 -->
						<div v-if="
              this.distributionType == 12 ||
              this.distributionType == 22 ||
              this.distributionType == 32 ||
              this.distributionType == 14
            ">
							<publicTitle title="批次基本信息"></publicTitle>
							<table :model="batchInfo" class="detail">
								<tr>
								...
								<tr>
									<td>制定时间</td>
									<td>
										<el-date-picker style="width: 100%" v-model="batchInfo.startDate" disabled placeholder="点击请选择年月日" label-width="7rem"></el-date-picker>
									</td>
									<td>批次结束时间</td>
									<td>
										<el-date-picker style="width: 100%" v-model="batchInfo.endDate" disabled placeholder="点击请选择年月日" label-width="7rem"></el-date-picker>
						...
						<div v-if="this.signType == 0">
							...
							<table :model="signUnitInfo" class="detail">
								<tr>
									...
									<td>证件类型</td>
									<td>
										<el-select v-model="signUnitInfo.ZJLX" clearable placeholder="请选择" style="width: 100%" disabled>
											<el-option v-for="(item, index) in zjlxOptions" :key="index" :label="item.name" :value="item.value"></el-option>
										</el-select>
									</td>
								</tr>
								<tr>
									...
									<td>性别</td>
									<td>
										<el-select v-model="signUnitInfo.XB" disabled placeholder="请选择" style="width: 100%">
											<el-option v-for="(item, index) in xbOptions" :key="index" :label="item.name" :value="item.value"></el-option>
										</el-select>
									</td>
								</tr>
								<tr>
									<td>出生日期</td>
									<td>
										<el-date-picker style="width: 100%" v-model="signUnitInfo.CSRQ" disabled placeholder="点击请选择年月日" label-width="7rem"></el-date-picker>
									</td>
									<td>婚姻状况</td>
									<td>
										<el-select v-model="signUnitInfo.HYZT" clearable placeholder="请选择" style="width: 100%" disabled>
											<el-option v-for="(item, index) in hyztOptions" :key="index" :label="item.name" :value="item.value"></el-option>
										</el-select>
									</td>
								</tr>
								<tr>
									<td>婚姻形成时间</td>
									<td>
										<el-date-picker style="width: 100%" v-model="signUnitInfo.JHSJ" disabled placeholder="点击请选择年月日" label-width="7rem"></el-date-picker>
									</td>
									<td>子女状况</td>
									<td>
										<el-select v-model="signUnitInfo.ZNZK" clearable placeholder="请选择" style="width: 100%" disabled>
											<el-option v-for="(item, index) in znzkoptions" :key="index" :label="item.name" :value="item.value"></el-option>
										</el-select>
									</td>
								</tr>
								<tr>
									<td>学历</td>
									<td>
										<el-select v-model="signUnitInfo.XL" clearable placeholder="请选择" style="width: 100%" disabled>
											<el-option v-for="(item, index) in xlOptions" :key="index" :label="item.name" :value="item.value"></el-option>
										</el-select>
									</td>
									<td>学位</td>
									<td>
										<el-select v-model="signUnitInfo.XW" clearable placeholder="请选择" style="width: 100%" disabled>
											<el-option v-for="(item, index) in xwOptions" :key="index" :label="item.name" :value="item.value"></el-option>
										</el-select>
									</td>
								</tr>
								<tr>
									<td>职务</td>
									<td>
										<el-select v-model="signUnitInfo.ZW" clearable placeholder="请选择" style="width: 100%" disabled>
											<el-option v-for="(item, index) in zwOptions" :key="index" :label="item.name" :value="item.value"></el-option>
										</el-select>
									</td>
									<td>职称</td>
									<td>
										<el-select v-model="signUnitInfo.ZGZC" clearable placeholder="请选择" style="width: 100%" disabled>
											<el-option v-for="(item, index) in zcOptions" :key="index" :label="item.name" :value="item.value"></el-option>
										</el-select>
									</td>
								</tr>
								<tr>
									<td>户口所在地</td>
									<td>
										<el-select v-model="signUnitInfo.HKSZD" clearable placeholder="请选择" style="width: 100%" disabled>
											<el-option v-for="(item, index) in hkszdOptions" :key="index" :label="item.name" :value="item.value"></el-option>
										</el-select>
									</td>
									<td>邮政编码</td>
									<td>
								...
								<tr>
									<td>单位性质</td>
									<td>
										<el-select v-model="signUnitInfo.DWXZ" clearable placeholder="请选择" style="width: 100%" disabled>
											<el-option v-for="(item, index) in dwxzOptions" :key="index" :label="item.name" :value="item.value"></el-option>
										</el-select>
									</td>
									<td>固定电话</td>
									<td>
                  ...
                  <el-input v-model="signInfo.fwsclx" clearable disabled></el-input>
									...
									<td>
										<el-select style="width: 100%" v-model="signInfo.fplx" disabled>
											<el-option v-for="(item, index) in fpywlxOptions" :key="index" :label="item.name" :value="item.value"></el-option>
										</el-select>
									</td>
								</tr>
								<tr>
								...
								<tr>
									<td>租赁起始日期</td>
									<td>
										<el-date-picker style="width: 100%" v-model="signInfo.zlkssj" disabled placeholder="点击请选择年月日" label-width="7rem"></el-date-picker>
									</td>
									<td>租赁结束日期</td>
									<td>
										<el-date-picker style="width: 100%" v-model="signInfo.zljssj" disabled placeholder="点击请选择年月日" label-width="7rem"></el-date-picker>
									</td>
								</tr>
								<tr>
									<td>租金金额</td>
									...
									<td>交租起始年月</td>
									<td>
										<el-date-picker style="width: 100%" v-model="signInfo.jzqsny" disabled placeholder="点击请选择年月日" label-width="7rem"></el-date-picker>
									</td>
								</tr>
								<tr>
									<td>首月应交租金</td>
									...
									<td>首次合同起始时间</td>
									<td>
										<el-date-picker style="width: 100%" v-model="signInfo.schtqssj" disabled placeholder="点击请选择年月日" label-width="7rem"></el-date-picker>
									</td>
								</tr>
								<tr>
									<td>托收银行</td>
							...
							<el-table :data="signOtherPersonalInfo" border :header-cell-style="globalHeaderStyle" :cell-style="globalCellStyle">
						...
						<div v-if="this.signType == 1">
							...
							<table :model="signUnitInfo" class="detail">
								<tr>
									...
									<td>单位性质</td>
									<td>
										<el-select v-model="signUnitInfo.XZ" clearable placeholder="请选择" style="width: 100%" disabled>
											<el-option v-for="(item, index) in dwxzOptions" :key="index" :label="item.name" :value="item.value"></el-option>
										</el-select>
									</td>
								</tr>
								...
								<tr>
									...
									<td>证件类型</td>
									<td>
										<el-select v-model="signUnitInfo.FRZJLX" clearable placeholder="请选择" style="width: 100%" disabled>
											<el-option v-for="(item, index) in zjlxOptions" :key="index" :label="item.name" :value="item.value"></el-option>
										</el-select>
									</td>
								</tr>
								...
								<tr>
									...
									<td>证件类型</td>
									<td>
										<el-select v-model="signUnitInfo.ZYZJLX" clearable placeholder="请选择" style="width: 100%" disabled>
											<el-option v-for="(item, index) in zjlxOptions" :key="index" :label="item.name" :value="item.value"></el-option>
										</el-select>
									</td>
								</tr>
								...
								<tr>
									...
									<td>证件类型2</td>
									<td>
										<el-select v-model="signUnitInfo.ZYZJLX2" clearable placeholder="请选择" style="width: 100%" disabled>
											<el-option v-for="(item, index) in zjlxOptions" :key="index" :label="item.name" :value="item.value"></el-option>
										</el-select>
									</td>
								</tr>
							...
							<table :model="signInfo" class="detail">
								...
								<tr>
									<td>租赁起始日期</td>
									<td>
										<el-date-picker style="width: 100%" v-model="signInfo.zlkssj" disabled placeholder="点击请选择年月日"></el-date-picker>
									</td>
									<td>租赁结束日期</td>
									<td>
										<el-date-picker style="width: 100%" v-model="signInfo.zljssj" disabled placeholder="点击请选择年月日"></el-date-picker>
									</td>
								</tr>
								<tr>
									<td>租金金额</td>
									...
									<td>交租起始年月</td>
									<td>
										<el-date-picker style="width: 100%" v-model="signInfo.jzqsny" disabled placeholder="点击请选择年月日"></el-date-picker>
									</td>
								</tr>
								<tr>
									<td>首月应交租金</td>
									...
									<td>首次合同起始时间</td>
									<td>
										<el-date-picker style="width: 100%" v-model="signInfo.schtqssj" disabled placeholder="点击请选择年月日"></el-date-picker>
									</td>
								</tr>
								<tr>
									<td>托收银行</td>
                ...
                <td>
                  <el-input v-model="signInfo" clearable disabled></el-input>
								...
								<tr>
									...
									<td>押金交款时间</td>
									<td>
										<el-date-picker style="width: 100%" v-model="signInfo.yjjksj" disabled placeholder="点击请选择年月日"></el-date-picker>
									</td>
								</tr>
								<tr>
									<td>合同类型</td>
								...
								<tr>
									<td>合同签订时间</td>
									<td>
										<el-date-picker style="width: 100%" v-model="signInfo.htqdsj" disabled placeholder="点击请选择年月日"></el-date-picker>
									</td>
									<td>首次签订时间</td>
									<td>
										<el-date-picker style="width: 100%" v-model="signInfo.schtqssj" disabled placeholder="点击请选择年月日"></el-date-picker>
								...
								<tr>
									...
									<td>领取钥匙时间</td>
									<td>
										<el-date-picker style="width: 100%" v-model="signInfo.lqyssj" disabled placeholder="点击请选择年月日"></el-date-picker>
									</td>
								</tr>
								<tr>
									<td>领取钥匙人</td>
			...
			<!-- 查看日志 -->
			<el-dialog title="查看日志" :visible.sync="logDialog" v-if="logDialog" width="80%" :close-on-click-modal="false">
				<el-form size="mini" :model="logForm" label-width="5rem">
					<el-row :gutter="20">
						<el-col :span="8">
							<el-form-item label="日志类型">
								<el-select v-model="logForm.auditType" clearable>
									<el-option v-for="(item, index) in logType" :label="item.name" :value="item.value" :key="index"></el-option>
								</el-select>
							</el-form-item>
						</el-col>
						<el-col :span="8">
							<el-form-item label="房屋状态">
								<el-select v-model="logForm.state" clearable>
									<el-option v-for="(item, index) in houseState" :label="item.name" :value="item.value" :key="index"></el-option>
								</el-select>
							</el-form-item>
						</el-col>
						<el-col :span="8">
				...
				<div class="table-list">
					<el-table :data="logList" border height="300" :header-cell-style="globalHeaderStyle" :cell-style="globalCellStyle">
			...
			<el-dialog title="查看历史" :visible.sync="historyDialog">
				<el-table :data="historyTable" border :header-cell-style="globalHeaderStyle" :cell-style="globalCellStyle">
					<el-table-column label="序号" type="index"></el-table-column>
				...
				<div class="page_box">
					<el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="currentPage"
					 :page-sizes="pageSizesList" :page-size="pageSize" layout="total, sizes, prev, pager, next, jumper" :total="total"
					 align="right" background></el-pagination>
				</div>
			</el-dialog>
			<!-- 维修状态-查看历史详情弹框 -->
		...
		<div style="width: calc(50% - 10px);height: 100%;float: left;" v-show="showMap" class="mapLocateDiv">
			<div class="resize" ref="resize" v-if="expandMap" @click="switchPanel(false,$event)">
				<i class="el-icon-d-arrow-right"></i>
			</div>
			<div class="resize" ref="resize" v-if="!expandMap" @click="switchPanel(true,$event)">
				<i class="el-icon-d-arrow-left"></i>
			</div>

			<i class="el-icon-circle-close" style="float: right;font-size: 20px;cursor: pointer;    padding: 15px;" @click="closeMap"></i>
			<i class="el-icon-full-screen"style="float: right;font-size: 20px;cursor: pointer;    padding: 15px;" v-show="!fullscreen" @click="fullScrren(true,$event)"></i>
			<i class="el-icon-copy-document" style="float: right;font-size: 20px;cursor: pointer;    padding: 15px;" v-show="fullscreen" @click="fullScrren(false,$event)"></i>
	...
	export default {
		...
		methods: {
			...
			goback() {
				...
				} else if (this.$route.query.childtitle == "房屋综合查询(市局)") {
					tab = {
						label: "房屋综合查询(市局)",
						name: "cityBureauInquire",
					};
				}else if (this.$route.query.childtitle == "房屋综合查询(第三方运营)") {
          tab = {
            label: "房屋综合查询(第三方运营)",
					...
					http
						...
						.then((res) => {
							if (res) {
								...
								this.$route.query.houseGuid = res.houseInfo.districtGuid;
			...
			location() {
				...
				// this.$route.query.houseGuid = this.$route.params.houseGuid;
				document.getElementsByClassName("house-details")[0].style.width = "50%";
				document.getElementsByClassName("house-details")[0].style.height = "100%";
				document.getElementsByClassName("house-details")[0].style.overflowY = "auto";
				document.getElementsByClassName("house-details")[0].style.float = "left";
				document.getElementsByClassName("pageStyle")[0].style.overflowY = "hidden";
				this.mapComponent = "MapInfo";
			...
			closeMap(){
				this.showMap=false;
				document.getElementsByClassName("house-details")[0].style.width = "100%";
				document.getElementsByClassName("house-details")[0].style.height = "100%";
				document.getElementsByClassName("house-details")[0].style.overflowY = "initial";
				document.getElementsByClassName("house-details")[0].style.float = "initial";
				document.getElementsByClassName("pageStyle")[0].style.overflowY = "auto";
				this.mapComponent = "";
			},
			switchPanel(mark){
				this.expandMap=!this.expandMap;
				if(mark){
					document.getElementsByClassName("house-details")[0].style.width = "30%";
					document.getElementsByClassName("mapLocateDiv")[0].style.width = "calc(70% - 10px)";
				}else{
					document.getElementsByClassName("house-details")[0].style.width = "50%";
					document.getElementsByClassName("mapLocateDiv")[0].style.width = "calc(50% - 10px)";
				}
			},
			fullScrren(mark){
				this.fullscreen=!this.fullscreen;
				if(mark){
					document.getElementsByClassName("house-details")[0].style.width = "0%";
					document.getElementsByClassName("mapLocateDiv")[0].style.width = "calc(100% - 10px)";
				}else{
					document.getElementsByClassName("house-details")[0].style.width = "50%";
					document.getElementsByClassName("mapLocateDiv")[0].style.width = "calc(50% - 10px)";
				}
			...
			goMapInfo() {
				...
				// document.getElementsByClassName("house-details")[0].parentElement.style.width="50%"
			...
			//         var left = document.getElementsByClassName('house-details');
			//         var mid = document.getElementsByClassName('mapLocateDiv');
			//         var box = document.getElementsByClassName('vacuumRoomDetail');
			...
			// 			document.getElementById('iframeMap').contentWindow.document.onmousemove = function (e) {
			// 			  var endX = e.clientX;
			// 			  var moveLen = resize[0].left + (endX - startX); // （endx-startx）=移动的距离。resize[i].left+移动的距离=左边区域最后的宽度
			// 			  var maxT = box[0].clientWidth - resize[0].offsetWidth;  // 容器宽度 - 左边区域的宽度 = 右边区域的宽度
			...
			// 			}
			// 			// 鼠标松开事件
			// 			document.getElementById('iframeMap').contentWindow.document.onmouseup = function (evt) {
			// 			  document.getElementById('iframeMap').contentWindow.document.onmousemove = null;
			// 			  document.getElementById('iframeMap').contentWindow.document.onmouseup = null;
			// 			  resize[0].releaseCapture && resize[0].releaseCapture(); //当你不在需要继续获得鼠标消息就要应该调用ReleaseCapture()释放掉
			// 			}
