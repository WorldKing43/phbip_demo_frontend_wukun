<!--
 * @Author: maxq
 * @Date: 2020-07-15 10:04:52
 * @LastEditTime: 2020-08-25 19:37:32
 * @LastEditors: Please set LastEditors
 * @Description: 房屋坐落变更-待办箱
 * @FilePath: \frontend\house-mnt\src\views\houseManagement\changeOfHouseLocation\HouseLocationTodo.vue
--> 
<template>
  <div id="house-location-todo">
    ...
    <div class="btn_box">
      <el-button size="mini" type="primary" @click="addNew()">新 增</el-button>
    </div>
...
export default {
  ...
  methods: {
    ...
    openCahe(val) {
      ...
      api.openCache(params).then(res => {}).catch(err => { console.log(err) });
    },
  },
  mounted() {
    this.search();//查询列表数据
