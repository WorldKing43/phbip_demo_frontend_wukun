      ...
      <div class="contentColor">
        ...
        <div class="toolbar" style="margin-left: 15px">
          <el-button
            ...
            @click="exportTable"
            size="mini"
            v-if="hasPerm('fygl_fwzhcx(dsfyy)_dc')"
            >导出</el-button
          >
          <!-- <el-button
            type="primary"
...
export default {
  ...
  data() {
    return {
      ...
      stateData: [
        { name: "空房", value: 14 },
        { name: "已预留", value: 1 }, //[20, 21, 22]
        { name: "准计划", value: 2 },
        { name: "已计划", value: 3 }, //[1,2,3,4,5,7,8,9,14]
        { name: "已分配未签约", value: 7 }, //[1,2,3,4,5,7,8,9,14]
        { name: "已出租", value: 8 }, //[1,2,3,4,5,7,8,9,14]
        { name: "已签协议未签合同", value: 9 }, //[1,2,3,4,5,7,8,9,14]
        { name: "已出售", value: 10 }, //[1,2,3,4,5,7,8,9,14]
        { name: "已取得全部产权", value: 11 }, //[1,2,3,4,5,7,8,9,14]
        { name: "已拆除", value: 21 }, //[1,2,3,4,5,7,8,9,14]
        { name: "长租住房租凭到期", value: 20 }, //[1,2,3,4,5,7,8,9,14]
        { name: "其他原因出库", value: 22 }, //[1,2,3,4,5,7,8,9,14]
        { name: "预房屋", value: 5 }, //[1,2,3,4,5,7,8,9,14]
        { name: "已备案", value: 23 },
      ], //房屋状态下拉
  ...
  methods: {
   ...
   /* exportTable() {
      ...
      url =
        process.env.API +
        inquery.exportThirdPartyOperationHouseInfo +
        "?districtNo=" +
...
// 导出按钮
    exportTable() {
      let data = {
        ...
        orientationList: this.form.orientationList,
        ...
        secondDistribution:this.form.secondDistribution,
    ...
    getHouseList(index) {
      ...
      let data = {
        ...
        orientationList: this.form.orientationList.length == 0 ? "" : this.form.orientationList,
        coveredAreaMax:this.form.coveredAreaMax,
        coveredAreaMin:this.form.coveredAreaMin,
        source:this.form.source.length == 0 ? "" : this.form.source,
        nature:this.form.nature.length == 0 ? "" : this.form.nature,
        state:this.form.state.length == 0 ? "" : this.form.state,
        propertyRight: this.form.propertyRight.length == 0 ? "" : this.form.propertyRight,
        situational:this.form.situational,
        districtNo: this.form.districtNo,
        buildNo: this.form.buildNo,
        operationalRight:this.form.operationalRight,
        situationalRemark:this.form.situationalRemark.length == 0 ? "" : this.form.situationalRemark,
        closed:this.form.closed,
        secondDistribution:this.form.secondDistribution,
        currentProperty:this.form.currentProperty,
        specification:this.form.specification.length == 0 ? "" : this.form.specification,
        completionAreaEnd:this.form.completionAreaEnd,
        completionAreabegain:this.form.completionAreabegain,
        demolitionState:this.form.demolitionState,
        maintainType:this.form.maintainType,
        //fpdw:this.form.fpdw.length == 0 ? "" : this.form.fpdw,
