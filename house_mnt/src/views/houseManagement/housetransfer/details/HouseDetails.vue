...
<template>
  <div class="house-details">
          ...
          <div>
            <table class="detail">
              ...
              <tr>
                ...
                <td>曾用房号</td>
                <td>
                  <el-input disabled v-model="form.usedHouseNo"></el-input>
                </td>
              </tr>
              <tr>
                <td>网格办编码</td>
          ...
          <div>
            <table class="detail">
              ...
              <tr>
                ...
                <td>权利人</td>
                <td>
                  <el-input disabled v-model="form.obligee"></el-input>
                </td>
              </tr>
              <tr>
                <td>使用开始时间</td>
              ...
              <tr>
                <td>登记价人民币</td>
                <td>
                  <el-input disabled v-model="form.registPrice"></el-input>
                </td>
                <td>房屋原值</td>
                <td>
                  <el-input
              ...
              <el-table-column label="操作" width="200px">
                <template slot-scope="scope">
                  <el-button
                    type="primary"
                    size="mini"
                    @click="checkAttachment(scope.row)"
                    >查看附件</el-button
                  >
                  <el-button
                    type="primary"
                    ...
                    @click="openRelieveDialog(scope.row)"
                    >解除</el-button
                  >
                </template>
              </el-table-column>
    ...
    >
      ...
      >
        <el-form-item label="权利人">
          <el-input
            v-model="propertyRightInfo.obligee"
            autocomplete="off"
          ></el-input>
        </el-form-item>
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="不动产单元号">
              <el-input
                v-model="propertyRightInfo.immovablePropertyUnitNo"
                autocomplete="off"
              ></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="登记价人民币">
              <el-input
                v-model="propertyRightInfo.registPrice"
                autocomplete="off"
              ></el-input>
            </el-form-item>
          </el-col>
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="套内面积">
              <el-input
                v-model="propertyRightInfo.indoorArea"
                autocomplete="off"
              ></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="共有情况">
              <el-input
                v-model="propertyRightInfo.commonalityCondition"
                autocomplete="off"
              ></el-input>
            </el-form-item>
          </el-col>
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="房屋现值">
              <el-input
                v-model="propertyRightInfo.housePresentPrice"
                autocomplete="off"
              ></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="房屋原值">
              <el-input
                v-model="propertyRightInfo.houseOriginalPrice"
                autocomplete="off"
              ></el-input>
            </el-form-item>
          </el-col>
        ...
        <el-row :gutter="20">
          <el-col>
            <el-form-item label="不动产证书号">
              <el-input
                v-model="propertyRightInfo.rightOverImmovablesId"
                autocomplete="off"
              ></el-input>
            </el-form-item>
          </el-col>
    ...
    <!-- 查看入住人信息模块 -->
    <el-dialog
      :visible.sync="checkPeopleDialog"
      title="查看入住人信息"
      width="60%"
      class="openPeople"
      :close-on-click-modal="false"
    >
      <div>
        <publicTitle title="家庭承租情况"></publicTitle>
        <!-- <p>
          <span>承租人:{{homeRetalForm.name}}</span>
          <span>联系电话:{{homeRetalInfo.mobilePhone}}</span>
        </p>-->
        <div class="table">
          <el-table
            :data="homeRetalInfo"
          ...
          >
            ...
            <el-table-column label="入住时间">
              <template slot-scope="scope">
                {{ scope.row.checkInTime | dateFormat }}
              </template>
            </el-table-column>
            <el-table-column label="搬离时间">
              <template slot-scope="scope">
                {{ scope.row.moveAwayTime | dateFormat }}
              </template>
            </el-table-column>
          </el-table>
        </div>
        <publicTitle title="单位承租情况"></publicTitle>
        <!-- <p>
          <span>单位名称:{{unitRetalForm.unitName}}</span>
          <span>住房专员1:{{unitRetalForm.houseMan}}</span>
          <span>联系电话1:{{unitRetalForm.houseManPhone}}</span>
          <span>住房专员2:{{unitRetalForm.houseMan2}}</span>
          <span>联系电话2:{{unitRetalForm.houseManPhone2}}</span>
        </p>-->
        <div class="table">
          <el-table
            :data="unitRetalInfo"
        ...
        <publicTitle title="家庭购房情况(含局建房)"></publicTitle>
        <!-- <p>
          <span>主申请人:{{homeBuyHouseForm.name}}</span>
          <span>联系电话:{{homeBuyHouseForm.mobilePhone}}</span>
          <span>合同签订时间:{{homeBuyHouseForm.contractTime}}</span>
          <span>退房时间:{{homeBuyHouseForm.moveAwayTime}}</span>
        </p>-->
        <div class="table">
          <el-table
            :data="homeBuyHouseInfo"
            border
            size="mini"
            :header-cell-style="globalHeaderStyle"
            :cell-style="globalCellStyle"
        ...
        <publicTitle title="单位购房情况"></publicTitle>
        <!-- <p>
          <span>单位名称:{{homeBuyHouseForm.name}}</span>
        </p>-->
        <div class="table">
          <el-table
            :data="unitBuyHouseInfo"
            border
            size="mini"
            :header-cell-style="globalHeaderStyle"
            :cell-style="globalCellStyle"
        ...
        <publicTitle title="单位房改房"></publicTitle>
        <!-- <p>
          <span>房改单位名称:{{unitHousingReformForm.name}}</span>
        </p>-->
        <div class="table">
          <el-table
            :data="unitHousingReformInfo"
            border
            size="mini"
            :header-cell-style="globalHeaderStyle"
            :cell-style="globalCellStyle"
    ...
    >
      <div>
        <publicTitle title="房源标注信息"></publicTitle>
        <div class="tableStyle">
          <table :model="situationalInfo" class="detail">
            <tr>
              <td>小区名称</td>
              <td>{{ situationalInfo.districtName }}</td>
              <td>栋号</td>
              <td>{{ situationalInfo.buildNo }}</td>
            </tr>
            <tr>
              <td>房号</td>
              <td>{{ situationalInfo.houseNo }}</td>
              <td>户型</td>
              <td>{{ situationalInfo.houseLayoutName }}</td>
            </tr>
            <tr>
              <td>建筑面积</td>
              <td style="position: relative">
                {{ situationalInfo.coveredArea }}
                <span
                  style="position: absolute; top: 3px; right: 2px"
                  v-if="situationalInfo.coveredArea"
                  >平方米</span
                >
              </td>
              <td>标记原因</td>
              <td>{{ situationalInfo.reason }}</td>
            </tr>
            <tr>
              <td>标记依据</td>
              <td>{{ situationalInfo.basis }}</td>
              <td></td>
              <td></td>
            </tr>
          </table>
        </div>
        <publicTitle title="解除房源标注信息"></publicTitle>
        <table class="situationalInfoStyle">
          <tr>
            <td>请填写解除标记依据</td>
            <td>
              <el-input
          ...
          <tr>
            <td>过程材料</td>
            <td>
              <Material :parameter="parameter"></Material>
            </td>
          </tr>
        </table>

        <div style="margin-top: 10px; text-align: center">
          <el-button size="mini" @click="relieveDialog = false">取消</el-button>
          <el-button type="primary" size="mini" @click="removeSituationalInfo"
            >确定</el-button
          >
        </div>
      </div>
    ...
    >
      <div>
        <el-button type="primary" size="mini" @click="openHousePlanDialog"
          >房源计划</el-button
        >
        <el-button
          type="primary"
          size="mini"
          @click="openAllocationBatchInfoDialog"
          >分配批次信息</el-button
        >
        <el-button type="primary" size="mini" @click="openSignUpInfoDialog"
          >签约信息</el-button
        >
        ...
        <div v-if="this.housePlanInfoShow">
          ...
          <table :model="housePlanFrom" class="detail">
            <tr>
              ...
              <td>
                <el-input
                  v-model="housePlanFrom.belongToName"
                  disabled
                ></el-input>
              </td>
              <td>房源计划号</td>
            ...
            <tr>
              ...
              <td colspan="3">
                <el-input
                  placeholder="请输入内容"
                  v-model="housePlanFrom.description"
                  disabled
                ></el-input>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <el-radio-group
                  disabled
                  v-model="housePlanFrom.function"
            ...
            <tr>
              ...
              <td>
                <el-input
                  v-model="housePlanFrom.batchCode"
            ...
            <tr>
              ...
              <td>
                <el-input
                  v-model="housePlanFrom.planEditor"
                  disabled
                ></el-input>
              </td>
              <td>编制时间</td>
              <td>
                <el-input
                  v-model="housePlanFrom.compileDate"
                  disabled
                ></el-input>
              </td>
            </tr>
            <tr>
              ...
              <td colspan="3">
                <el-input
                  v-model="housePlanFrom.activityName"
                  disabled
                ></el-input>
              </td>
            </tr>
              ...
              <el-row :gutter="10">
                ...
                <el-col :span="6">
                  <el-form-item style="text-align: right">
                    <el-button type="primary" @click="getHousePlanList(1)"
                      >查询</el-button
                    >
                  </el-form-item>
                </el-col>
          ...
          <div v-if="this.distributionType == 11">
            ...
            <table :model="batchInfo" class="detail">
              ...
              <tr>
                ...
                <td>
                  <el-select
                    v-model="batchInfo.distributeType"
                    class="w100"
                    clearable
                    disabled
                  >
              ...
              <tr>
                ...
                <td>
                  <el-input
                    v-model="batchInfo.distributionSubjectName"
                    clearable
                    disabled
                  ></el-input>
                </td>
          ...
          >
            ...
            <table :model="batchInfo" class="detail">
              ...
              <tr>
                <td>批次备注</td>
                <td colspan="3">
                  <el-input v-model="batchInfo.remark" disabled></el-input>
                </td>
              </tr>
            </table>
          </div>
          ...
          <div v-if="this.signType == 0">
            ...
            <table :model="signUnitInfo" class="detail">
              ...
              <tr>
                <td>移动电话1</td>
                <td>
                  <el-input v-model="signUnitInfo.SJHM" disabled></el-input>
                </td>
                <td>移动电话2</td>
                <td>
                  <el-input v-model="signUnitInfo.SJHM2" disabled></el-input>
                </td>
              </tr>
              <tr>
                <td>工作单位</td>
                <td colspan="3">
                  <el-input v-model="signUnitInfo.DWMC" disabled></el-input>
                </td>
              </tr>
              <tr>
                <td>通讯地址</td>
                <td colspan="3">
                  <el-input v-model="signUnitInfo.TXDZ" disabled></el-input>
                </td>
              </tr>
              <tr>
                <td>单位性质</td>
              ...
              <tr>
                <td>承租信息备注</td>
                <td colspan="3">
                  <el-input v-model="signUnitInfo.BZ" disabled></el-input>
                </td>
              </tr>
            </table>
          ...
          <div v-if="this.signType == 1">
            ...
            <table :model="signUnitInfo" class="detail">
              ...
              <tr>
                ...
                <td>
                  <el-input
                    v-model="signUnitInfo.YUAN_DWZJHM"
                    clearable
                    disabled
                  ></el-input>
                </td>
              ...
              <tr>
                ...
                <td>
                  <el-input
                    v-model="signUnitInfo.ZFZYLXDH2"
                    disabled
                  ></el-input>
                </td>
              </tr>
...
import checkLog from "../dialog/CheckLog";
