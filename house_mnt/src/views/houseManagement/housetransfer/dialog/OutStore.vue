  ...
  <div class="dialog">
    <div class="dialog-content">
      <div class="dialog-left">
        <el-form :model="dialogLeftForm" size="mini" label-position="left">
          ...
          <el-row :gutter="20">
            ...
            <el-col :span="12">
              <el-button type="primary" size="mini" @click="getHouseList(1)">查询</el-button>
            </el-col>
          </el-row>
        </el-form>
        <p>请选择需要核销的房源</p>
        ...
        >
          ...
          <el-table-column prop="coveredArea" label="预测绘建筑面积(平方米)" width="170px"></el-table-column>
          <el-table-column prop="completionArea" label="竣工建筑面积(平方米)" width="150px"></el-table-column>
      ...
      <div class="dialog-center">
        ...
        <el-button @click="handleRemove" style="margin-left:0;" size="mini">
      ...
      <div class="dialog-right">
        ...
        >
          ...
          <el-table-column prop="houseNo" label="房号"></el-table-column>
          <el-table-column prop="typeName" label="户型"></el-table-column>
          <el-table-column prop="coveredArea" label="预测绘建筑面积(平方米)" width="160px"></el-table-column>
          <el-table-column prop="completionArea" label="竣工建筑面积(平方米)" width="150px"></el-table-column>
          <el-table-column prop="changeAfterNatureName" label="房屋性质" :show-overflow-tooltip="true"></el-table-column>
        </el-table>
      </div>
    ...
    <div class="dialog-footer">
      <el-form v-model="rightsForm" size="mini" style="width:84%">
        <el-form-item label="请选择核销原因" label-width="8rem" :rules="rulesx">
          <el-select v-model="rightsForm.state" clearable placeholder="请选择核销原因" style="width:98%">
            <el-option
        ...
        <el-form-item label="请填写核销依据" label-width="8rem" :rules="rulesx">
          <el-input v-model="rightsForm.reason" type="textarea" style="width:98%"></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleAdd() {
      ...
      // this.tableRightData = this.leftSelection; //ywj
    ...
    // 提交
    submit() {
      console.log(this.rightsForm.state);
      if (this.rightSelection.length == 0) {
        this.$message({
          type: "warning",
          message: "请勾选房源"
        });
      } else if (this.rightsForm.state.length == 0) {
        this.$message({
          type: "warning",
          message: "请选择核销原因"
        });
        ...
        this.$confirm(`确定将选中房源核销?`, "提示", {
          ...
          .then(() => {
            ...
            let params = {
              changeValue: this.rightsForm.state,
              properties: ["outStock"].toString(),
            ...
            http
              ...
              .then(res => {
                ...
                let _parmas = {
                  operation: "核销",
                  reason: this.rightsForm.state,
                  basis: this.rightsForm.reason
                };
