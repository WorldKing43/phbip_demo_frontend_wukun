  ...
  <div class="dialog">
      ...
      <div class="dialog-right">
        <el-form :model="dialogRightForm" size="mini" label-width="4rem">
          ...
          <el-row :gutter="20">
            ...
            <el-col :span="12">
              <el-button type="primary" @click="rightSearch" size="mini">查询</el-button>
            </el-col>
          </el-row>
        </el-form>
        <p>
    ...
    <div class="dialog-footer">
      <el-form v-model="rightsForm" size="mini" style="width:84%">
        <el-form-item label="请填写预留依据" label-width="8rem" :rules="rulesx">
          <el-input type="textarea" v-model="rightsForm.reason" style="width:98%"></el-input>
        </el-form-item>
